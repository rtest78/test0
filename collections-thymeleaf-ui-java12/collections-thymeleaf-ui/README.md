...
- Spring Boot 2.7 and Thymeleaf UI
...
## Eclipse / Java 12 compatibility

This version uses regular JavaBean classes with constructors, getters, and setters. It does not use Java records or Stream.toList().
